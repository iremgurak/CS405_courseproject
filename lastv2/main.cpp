...
int main()
{
    ...
    //4th floor
    GameObj3D* floor4 = new GameObj3D(cubeModel1);
    floor4->translate(180, -1, -200);
    floor4->scale(10, 0.5, 100);
    floor4->textureId = 1;
    ...
    //added for text!!
    Shader2 textShader("lastv2/shader/text.vs", "lastv2/shader/text.fr");
    glm::mat4 projection3 = glm::ortho(0.0f, static_cast<float>(SHADOW_WIDTH), 0.0f, static_cast<float>(SHADOW_HEIGHT));
    textShader.use();
    glUniformMatrix4fv(glGetUniformLocation(textShader.ID, "projection"), 1, GL_FALSE, glm::value_ptr(projection3));
    ...
    // find path to font
    std::string font_name = "C:/Users/iremg/Source/Repos/Project1/lastv2/Zabdilus.ttf";
    if (font_name.empty())
    {
